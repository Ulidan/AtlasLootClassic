...
local P1_DIFF = data:AddDifficulty(AL["Phase 1"], "p1", 1, nil, true)
local P4_DIFF = data:AddDifficulty(AL["Phase 4"], "p4", 2, nil, true)
local P5_DIFF = data:AddDifficulty(AL["Phase 5"], "p5", 3, nil, true)
